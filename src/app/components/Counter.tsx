...
function Counter({ disabled, product, quantity, setQuantity }: {disabled?: boolean, product: Product, quantity: number, setQuantity: Dispatch<SetStateAction<number>>}) {
    ...
    return (
        <div className="min-w-28 w-1/2 h-auto flex items-center rounded-md border-2 border-gray-100 dark:border-neutral-800 font-semibold">
            ...
            <p className="h-8 flex grow items-center justify-center border-x-2 border-gray-100 dark:border-neutral-800">{disabled ? "-" : `${quantity}`}</p>
