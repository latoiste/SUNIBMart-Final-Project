...
function Counter({ product, quantity, setQuantity }: {product: Product, quantity: number, setQuantity: Dispatch<SetStateAction<number>>}) {
    function increment() {
    ...
    return (
        <div className="w-1/2 h-auto flex items-center rounded-md border-2 border-gray-100 font-semibold">
